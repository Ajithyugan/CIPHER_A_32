...
* Function List: (startScanner, tokenizer, printScannerError,
	displayScanner, getScannerFilesize, printToken, mainScanner).
*************************************************************/
...
/* __DATE__, __TIME__, __LINE__, __FILE__, __STDC__ are predefined preprocessor macros*/
	...
	sourceBuffer = bufferCreate(CIPHER_DEFAULT_SIZE, CIPHER_DEFAULT_INCREMENT, MODE_MULTI);
	...
	stringLiteralTable = bufferCreate(CIPHER_DEFAULT_SIZE, CIPHER_DEFAULT_INCREMENT, MODE_ADDIT);
